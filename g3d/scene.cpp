...
//    
//    Particule<3> *p1 = new Particule<3>(vec1, vec0);
//    Particule<3> *p2 = new Particule<3>(vec2, vec0);
//    Particule<3> *p3 = new Particule<3>(vec3, vec0);
//    Particule<3> *p4 = new Particule<3>(vec4, vec0);
//    Particule<3> *p5 = new Particule<3>(vec5, vec0);
//    Particule<3> *p6 = new Particule<3>(vec6, vec0);
//    Particule<3> *p7 = new Particule<3>(vec7, vec0);
//    Particule<3> *p8 = new Particule<3>(vec8, vec0);
//    Particule<3> *p9 = new Particule<3>(vec9, vec0);
//    Particule<3> *p10 = new Particule<3>(vec10, vec0);
//    
//    f = new Fluide<3>(m);
