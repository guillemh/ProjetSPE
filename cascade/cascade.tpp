...
void Cascade<Dim>::draw() {
    ...
    glNormal3f (1, 0, 0);
    glVertex3f (bassin_x/2+0.1, -bassin_y/2-0.1, -0.1);
    glVertex3f (bassin_x/2+0.1, 0-bassin_y/5, -0.1);
    glVertex3f (bassin_x/2+0.1, 0-bassin_y/5, bassin_z-0.025+0.1);
    ...
    glNormal3f (1, 0, 0);
    glVertex3f (bassin_x/2+0.1, 0-bassin_y/5, bassin_z/5-0.025);
    glVertex3f (bassin_x/2+0.1, 0+bassin_y/5, bassin_z/5-0.025);
    glVertex3f (bassin_x/2+0.1, 0+bassin_y/5, bassin_z-0.025+0.1);
    glVertex3f (bassin_x/2+0.1, 0-bassin_y/5, bassin_z-0.025+0.1);  
    ...
    glVertex3f (bassin_x/2+0.1, 0-bassin_y/5, -0.1);
    glVertex3f (bassin_x/2+0.1, 0+bassin_y/5, -0.1);
    glVertex3f (bassin_x/2+0.1, 0+bassin_y/5, -0.025);
    glVertex3f (bassin_x/2+0.1, 0-bassin_y/5, -0.025);  
    ...
    glNormal3f (1, 0, 0);
    glVertex3f (bassin_x-0.1, -bassin_y-0.1, 0-3.0+0.001);
    glVertex3f (bassin_x-0.1, bassin_y+0.1, 0-3.0+0.001);
    ...
    glVertex3f (6*bassin_x, bassin_y, 0-3.0+0.001);
    glVertex3f (6*bassin_x, bassin_y, bassin_z/5-3.0+0.001);
    glVertex3f (6*bassin_x, -bassin_y, bassin_z/5-3.0+0.001);  

    glNormal3f (1, 0, 0);
    glVertex3f (6*bassin_x+0.1, -bassin_y-0.1, 0-3.0+0.001);
    glVertex3f (6*bassin_x+0.1, bassin_y+0.1, 0-3.0+0.001);
